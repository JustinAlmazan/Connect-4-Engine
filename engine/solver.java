...
{   
    ...
    public static int negamax(Position p, int alpha, int beta)
    {
        ...
        int val = transTable.get(p.board);
        ...
        transTable.put(p.board, (byte)(alpha - Position.MIN_SCORE - 1));
...
class TranspositionTable
{
    ...
    public byte get(long key)
    {
        ...
        if (T.containsKey(i) && T.get(i).key == key) return T.get(i).val;
        else return 0;
    }
}
